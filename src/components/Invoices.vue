<template>
    ...
    <edit-dialog-container v-if="editItem" :data-item="itemObj" @sendEmail="sendEmail" @editInvoice="editInvoice" @editClose="editClose">
  ...
  export default {
    ...
    getFunction(){
     ...
     btnSwitch(){
      ...
      editInvoice(){
        const invNum =  invID[5];
        localStorage.setItem('InvNo', invNum);
        console.log(invNum);
